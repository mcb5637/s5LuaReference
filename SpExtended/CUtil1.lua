...
---@param string path
---@return boolean exists
function CUtil.DoesFileExist() end
...
---@param number _entityType
---@return number ...
function CUtil.GetBuildOns() end
...
-- Gibt Koordinaten des Gebäudes im Platziermodus zurück.
---@return number x
---@return number y
...
-- Intern, Gibt zurück ob eine GUI aktuell geladen ist.
---@return boolean exists
...
function CUtil.ScriptSignalColored(_x, _y, _r, _g, _b) end
