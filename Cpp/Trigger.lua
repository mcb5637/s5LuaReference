...
---@param _conFunc string|nil Aufgerufen wird: _G[_conFunc](unpack(_conParam)). Muss true returnen, damit _actFunc aufgerufen wird. nil,""->immer ausgeführt
...
---@param _conParam table|nil table mit Parametern für _conFunc. darf nur numbers und strings enthalten.
---@param _actParam table|nil table mit parametern für _actFunc. darf nur numbers und strings enthalten.
---@return number tid
